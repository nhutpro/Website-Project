      ...
      items
        .aggregate([
...

          {
            ...
            $match: {
              $or: [
                { "slug": { $elemMatch: { "color": { $elemMatch: { "price": { $gte: paramPrice } } } } }, },

                //               {"slug" : {$elemMatch: { "color":   {$elemMatch:{ "price":{$lt: to2}}}  }}, },

                //        {"slug" : {$elemMatch: { "color":   {$elemMatch:{ "price": {$elemMatch: {$gte: from2,$lt: to5} } }}  }}, },

                { "slug": { $elemMatch: { "color": { $elemMatch: { "price": { $gte: from5, $lt: to14 } } } } }, },

                { "slug": { $elemMatch: { "color": { $elemMatch: { "price": { $gte: from14 } } } } }, },
